...
Windows 11 all-in-one setup designer. Pick apps from the catalog, add anything that is missing, then export a double-click setup program that installs exactly that set on a new PC.
